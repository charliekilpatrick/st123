...
[![Build and Test](https://github.com/charliekilpatrick/st123/actions/workflows/ci.yml/badge.svg)](https://github.com/charliekilpatrick/st123/actions/workflows/ci.yml)
[![Documentation](https://github.com/charliekilpatrick/st123/actions/workflows/documentation.yml/badge.svg)](https://github.com/charliekilpatrick/st123/actions/workflows/documentation.yml)
[![Docs site](https://img.shields.io/badge/docs-GitHub%20Pages-blue)](https://charliekilpatrick.github.io/st123/)
...
- **Layout:** Installable package under `st123/`; console CLIs in `st123/scripts/`; shared helpers in `st123/utils/`; alignment / mosaic / photometry / MAST under matching subpackages; notebooks in `st123/notebooks/`; custom JHAT under `extdeps/jhat/`
- **Tests:** `pytest` in `tests/` (see `pyproject.toml`)
- **Provenance:** New repository (not a GitHub fork) descending from
  ...
  (`dev-cdk` snapshot). Package and CLI names use `st123` for the broader
  HST / JWST / Roman scope.
...
Each CLI writes a UTC log under
`<base-dir>/logs/{script}_{YYYYMMDD_HHMMSS}_{uid}.log` (or `./logs/` when
`--base-dir` is omitted).
...
**Citation:** C. D. Kilpatrick & A. Suresh, _st123: space-telescope download,
alignment, mosaic, and DOLPHOT helpers_, GitHub
(https://github.com/charliekilpatrick/st123). If a DOI (e.g. Zenodo) is
...
* Kilpatrick, C. D., Suresh, A., et al., “The Type II SN 2025pht in NGC 1637: A
  ...
  Detection of a Supernova Progenitor Star,” _ApJL_ **992**, L10 (2025).
...
* Blanchard, P. K., Berger, E., Andrew, S. E., Suresh, A., Uno, K.,
  ...
  and Implications for the Progenitors of Fast Radio Bursts,” _ApJL_ **989**,
  L49 (2025).
...
* Aswin Suresh — aswin.suresh@northwestern.edu
